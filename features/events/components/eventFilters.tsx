...
export const EventFilters = forwardRef<EventFiltersRef, EventFiltersProps>(
  ({ onFilterChange }, ref) => {
    ...
    // Expose resetFilters function through ref
    ...
    // Use a single useEffect to manage all filter changes
    useEffect(() => {
      // Only send filter changes to parent if this is an internal update (not from parent)
      const newFilters = {
        ...filters,
