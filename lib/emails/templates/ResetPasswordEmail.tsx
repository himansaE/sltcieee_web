  ...
  return (
    <Html>
      <Head>
        ...
        <Preview>Reset your SLTC IEEE admin password</Preview>
      </Head>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.mainSection}>
            <Heading style={styles.header}>Reset Your Password</Heading>
            ...
            <Section style={styles.content}>
              ...
              <Text style={styles.paragraph}>
                ...
                with the SLTC IEEE Admin Portal. If you didn&apos;t make this
...
const styles = {
  ...
  header: {
    backgroundColor: "#00629B", // IEEE blue instead of #006699
    color: "#ffffff",
    padding: "30px",
    textAlign: "center" as const,
    fontSize: "24px",
